...
public class BookingController {
	...
	public static boolean AddRecord(Booking B) {
		try {
			...
			String query = "insert into bookings(clientemail,mobile,vehicleid,currentdate,bfrom,bto,source,destination,status) values('"
					+ B.getClientEmail() + "','" + B.getMobile() + "','" + B.getVehicleId() + "','" + B.getCurrentDate()
					+ "','" + B.getBookingFrom() + "','" + B.getBookingTo() + "','" + B.getSource() + "','"
					+ B.getDestination() + "','" + B.getStatus() + "')";
