...
public class ClientProfile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// String
			// navbar="<h4>&emsp;"+C.getEmail()+"&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;"+C.getFirstname()+"&nbsp;"+C.getLastname()+"&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;"+ltime+"&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a
			// href='ClientLogout'>Logout</a></h4><hr color=Green><br>";
			// out.println(navbar);
		} catch (Exception e) {
			// out.println(e);
		...
		out.println("" + "<tr><tr></tr></tr>" + "<tr><td><b><i>Email ID:</i></b></td>"
				+ "<td><input class='form-control' type=text name=email id=email value=" + C.getEmail() + "></td></tr>"
				+ "<tr><td><b><i>Mobile:</i></b></td>"
				+ "<td><input class='form-control' type=text name=mobile id=mobile value=" + C.getMobile()
				+ "></td></tr>" + "<tr><td><b><i>First Name:</i></b></td>"
				+ "<td><input class='form-control' type=text name=fname id=fname value=" + C.getFirstname()
				+ "></td></tr>" + "<tr><td><b><i>Last Name:</i></b></td>"
				+ "<td><input class='form-control' type=text name=lname id=lname value=" + C.getLastname()
				+ "></td></tr>" + "<tr><td><b><i>Date of Birth:</i></b></td>"
				+ "<td><input class='form-control' type=date name=dob id=dob value=" + C.getDob() + "></td></tr>"
				+ "<tr><td><b><i>Gender:</i></b></td>" + "<td><select class='form-control' name=gen id=gen>"
		...
		out.println("<tr><td><b><i>Address:</i></b></td>"
				+ "<td><textarea class='form-control' name=add id=add rows=3 cols=22 value=" + C.getAddress()
				+ "></textarea></td></tr>" + "<tr><td><b><i>State:</i></b></td>"
				+ "<td><select class='form-control'  name=state id=state value=" + C.getState() + "></select></td></tr>"
				+ "<tr><td><b><i>City:</i></b></td>" + "<td><select class='form-control' name=city id=city>"
				+ C.getCity() + "</select></td></tr>");
