...
import com.hrrock.model.Client;
...
public class ClientHome extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// out.println("<li class='panel'><a class='accordion-toggle collapsed'
		// href='#forms-collapse'><i class='fa fa-edit'></i> <span
		// class='name'>Forms</span></a></li> ");
		out.println(
				"<li class='panel'><a class='accordion-toggle collapsed' href=ClientProfile target=mw><i class='fa fa-edit'></i> <span class='name'>Edit Profile</span></a></li>");
		out.println(
				"<li class='panel'><a class='accordion-toggle collapsed' href=ClientChangePassword target=mw><i class='fa fa-edit'></i> <span class='name'>Change Password</span></a></li>");
		out.println(
				"<li class='panel'><a class='accordion-toggle collapsed' href=DisplayAgencyBidClient target=mw><i class='fa fa-edit'></i> <span class='name'>Show All Bids</span></a></li>");
		out.println(
				"<li class='panel'><a class='accordion-toggle collapsed' href=CurrentBookings target=mw><i class='fa fa-edit'></i> <span class='name'>Current Booking</span></a></li>");
		out.println(
				"<li class='panel'><a class='accordion-toggle collapsed' href=PreviousBooking target=mw><i class='fa fa-edit'></i> <span class='name'>Previous Bookings</span></a></li>");
		out.println(
				"<li class='panel'><a class='accordion-toggle collapsed' href=ClientLogin><i class='fa fa-edit'></i> <span class='name'>Logout</span></a></li>");
		...
		out.println("                    </li>");
		out.println(
				"                    <li class='hidden-xs'><a href='AdminLogin'><i class='fa fa-sign-out'></i></a></li>");
		out.println("                </ul>  ");
		out.println("        </div>");
		out.println("    </header>");
		...
		try {
			...
			String navbar = "<h5><center>" + C.getEmail() + "&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;"
					+ C.getFirstname() + "&nbsp;" + C.getLastname()
					+ "&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;" + ltime
					+ "&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href='ClientLogout' class='btn btn-info btn-xs'>Logout</a></center></h5>";
			out.println(navbar);
		} catch (Exception e) {
			// out.println(e);
		...
		out.println("  <iframe style='width:100%; height:800px;' src=ConfirmBooking frameborder=0 name=mw></iframe>");
		out.println("                    </div>");
		out.println("                </section>");
		out.println("            </div>");
		out.println("        </div>");
