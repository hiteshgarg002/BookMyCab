	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			out.println(""
					...
					// + "<tr><td><b><i>Picture Id </i></b></td><td><input type=text id=pic
					// name=pic></td></tr>"
					+ "<tr></tr><tr><td><b><i>Agency Id &emsp;</i></b></td>"
					+ "<td><input type=text class='form-control' id=agency name=agency value="
					+ ((Agency) ses.getValue("SAGENCY")).getAgencyid() + " readonly=true></td></tr>"
					...
					+ "<td><input type=file class='form-control' name=photo></td></tr>" + "</table>"
