...
public class ClientVehicleRequest extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<head>");
		/////////
		out.println("<script src='asset/jquery-3.2.1.min.js'></script>" + "<script src='asset/statecity.js'></script>"
				+ "<script src='asset/clientreg.js'></script>" + "<script src='asset/jquery-ui.js'></script>"
		...
		out.println("" + "<table class='table table-bordered' align=center cellspacing=5 cellpadding=5>" + "<tr>"
				+ "<td><img src=vehiclepicture/" + request.getParameter("vpicture") + " width=100 height=100></td>"
				+ "<td>" + "<b><i>Vehicle Id:</i></b>" + request.getParameter("vid") + "<br>" + "<b><i>Vehicle:</i></b>"
				+ request.getParameter("vn") + "(" + request.getParameter("vftype") + ")<br>" + "<b><i>Model:</i></b>"
				+ request.getParameter("vmodel") + "<br>" + "<b><i>Color:</i></b>" + request.getParameter("vcolor")
				+ "<br>" + "</td>" + "<td>" + "<b><i>Type:</i></b>" + request.getParameter("vtype") + "<br>"
				+ "<b><i>Capacity:</i></b>" + request.getParameter("vcapacity") + "<br>" + "<b><i>Inssurance</i></b>"
				+ request.getParameter("vins") + "<br>" + "<b><i>AC:</i></b>" + request.getParameter("vac") + "<br>"
				+ "</td>");
		out.println("<td>");
		...
		// signup form
		out.println("<td valign=top>" + "<table valign=top align=center cellspacing=4 cellpadding=2 class=''>"
				+ "<caption><b><i>Client Registration</i></b></caption>" + "<tr><tr></tr></tr>"
				...
				+ "<tr><td><b><i>Gender:</i></b></td>" + "<td><select class='form-control' id=gender>"
				+ "<option>Male</option>" + "<option>Female</option>" + "<option>other</option></select></td></tr>");

		out.println("<tr><td><b><i>Address:</i></b></td>"
				+ "<td><textarea class='form-control' id=add rows=3 cols=32></textarea></td></tr>"
				+ "<tr><td><b><i>State:</i></b></td>" + "<td><select class='form-control' id=state></select></td></tr>"
				+ "<tr><td><b><i>City:</i></b></td>" + "<td><select class='form-control' id=city></select></td></tr>"

				+ "<tr><td><b><i>Password:</i></b></td>"
				+ "<td><input class='form-control' type=password id=pwd size=30></td></tr>"
				+ "<tr><td><b><i>Confirm Password:</i></b></td>"
				+ "<td><input class='form-control' type=password id=cpwd size=30></td></tr>" + "</table><br>"
		...
		out.println(
				"        <script type='text/javascript' src='ui/plugins/owl-carousel/owl.carousel.min.js'></script>");
		out.println(
				"        <script type='text/javascript' src='ui/plugins/FlexSlider/jquery.flexslider-min.js'></script>");
