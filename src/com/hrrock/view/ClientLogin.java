...
public class ClientLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h4>Client Login to your account</h4>");
		out.println("</header>");
		out.println("<div class='body'>");
		out.println("<form class='no-margin' action=ClientLoginCheck method=post>");
		out.println(" <fieldset>");
		out.println(" <div class='form-group no-margin'>");
		out.println(" <label for='email' >CLIENT ID</label>");
		out.println(" <div class='input-group input-group-lg'>");
		out.println(" <span class='input-group-addon'>");
		out.println(" <i class='eicon-user'></i>");
		out.println(" </span>");
		out.println("<input  type='text' name=uid id=uid class='form-control input-lg' placeholder='Your ID'>");
		out.println("</div>");
		out.println("</div>");
