...
public class AgencyView extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println(
				"<td><input class='form-control' type=text readonly=true name=status size=30 value='Not Verified'></td></tr>");

		out.println("</table><br>");
		out.println(
				"<input type=submit class='btn btn-success'>&nbsp;&nbsp;<input class='btn btn-danger' type=reset></br>");
