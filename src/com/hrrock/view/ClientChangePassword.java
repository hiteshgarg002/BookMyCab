...
public class ClientChangePassword extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<td><input class='form-control' type=text name=opwd value='" + C.getPassword()
				+ "' size=30></td></tr><br>");
		...
		out.println(
				"<td>&nbsp;<input class='form-control' type=text name=cpwd size=30></td></tr></form></table></html><br>");
